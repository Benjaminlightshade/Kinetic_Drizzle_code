...
// Constants //
#define max_drop_pos 10000                      // Max drop pos corresponds to the physically lowest position. 
...
#define min_drop_pos -10000                     // Maximum that the drops can go up to hit calibration. Exists as an imaginary upper limit. 
...
// Pins //
#define PIN_NUM_RCLK 11 // Shift register RCLK - latch pin
